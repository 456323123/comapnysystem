                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <img src="{{ asset('uploads/employees/'.$emp->photo) }}" width="100">
                                                            <div class="position-relative has-icon-left">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="position-relative has-icon-left">
                                                                <input type="text" id="password-icon" class="form-control" name="department" placeholder="Department" value="{{ $emp->department }}" required>
                                                                <div class="form-control-position">
                                                                    <i class="feather icon-user"></i>
                                                                </div>
                                                            </div>
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-6">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="position-relative has-icon-left">
                                                                                                <input type="number" id="first-name-icon" class="form-control" name="trn" value="{{ $emp->trn }}" placeholder="TRN" required>
                                                                                                <div class="form-control-position">
                                                                                                    <i class="feather icon-user"></i>
                                                                                                </div>
                                                                                            </div>
